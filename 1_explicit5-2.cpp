...
//==================================
// 최종 결론
// 1. 생성자 만들때  => explicit 로 할지를 반드시 고려 하세요..
//					  explicit 를 붙이는 것이 안전 합니다.!!!
// 2. 변환 연산자
// => C++ 언어를 깊이 있게 이해 하려면 반드시 알아야 합니다.(학습)
// => 현업에서는 위험 할수 있으므로 되도록 사용하지 마세요..
// => 사용하려면 explicit 버전을 사용하세요

if (cin) {} // 왜?? 이렇게 하려고 하나요 ??
if (cin.fail()) {} // 이렇게 하면 되는데..!!!!